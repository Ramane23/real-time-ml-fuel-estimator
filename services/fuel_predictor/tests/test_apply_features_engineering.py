...
def test_apply_preprocessing():
    ...
    assert X_transformed.dtypes['hour_of_day'] == 'int32'
    assert X_transformed.dtypes['minute_of_hour'] == 'int32'
    assert X_transformed.dtypes['day_of_week'] == 'int32'
    assert X_transformed.dtypes['day_of_month'] == 'int32'
    assert X_transformed.dtypes['month'] == 'int32'
